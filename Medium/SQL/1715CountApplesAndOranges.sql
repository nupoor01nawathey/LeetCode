...
-- This table contains information about the chests we have, and the corresponding number 
-- if oranges and apples they contain.
...
SELECT
  SUM(CASE WHEN b.chest_id IS NULL THEN b.apple_count
