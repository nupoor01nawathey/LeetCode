...
insert into uservisits values(1,'2020-12-03'); 
insert into uservisits values(2,'2020-10-05'); 
insert into uservisits values(2,'2020-12-09'); 
...
WITH cte as (
  SELECT 
    *,
    LEAD(visit_date, 1) OVER(PARTITION BY user_id ORDER BY visit_date) next_date
  FROM uservisits
),
cte2 AS (
  SELECT 
