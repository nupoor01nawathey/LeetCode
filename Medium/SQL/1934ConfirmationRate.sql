...
-- The confirmation rate is confirmed/total request sent which is 1 / 2 = 0.5.

create table signups(user_id int,time_stamp datetime);
create table confirmations(user_id int,time_stamp datetime,action enum('timeout','confirmed'));
