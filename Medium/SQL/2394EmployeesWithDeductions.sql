...
-- Employees work in sessions. The number of hours an employee worked can be calculated from the sum of the number of minutes the employee worked in all of their sessions. 
...
insert into logs values(1,'2022-10-01 09:00:00','2022-10-01 17:00:00');
insert into logs values(1,'2022-10-06 09:05:04','2022-10-06 17:09:03');
insert into logs values(1,'2022-10-12 23:00:00','2022-10-13 03:00:01');
insert into logs values(2,'2022-10-29 12:00:00','2022-10-29 23:58:58');
...
WITH cte AS (
  SELECT
    employee_id,
    SUM(CEIL(TIMESTAMPDIFF(second, in_time, out_time)/60)) as in_odc_time
  FROM logs
...
WHERE e.needed_hours * 60 > IFNULL(c.in_odc_time, 0)
;
