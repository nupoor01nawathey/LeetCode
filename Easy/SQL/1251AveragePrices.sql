...
create table units_sold(product_id int, purchase_date date, units int);

insert into units_sold values(1, date('2019-02-25'), 100);
insert into units_sold values(1, date('2019-03-01'), 15);
insert into units_sold values(1, date('2019-02-10'), 200);
insert into units_sold values(1, date('2019-03-22'), 30);
